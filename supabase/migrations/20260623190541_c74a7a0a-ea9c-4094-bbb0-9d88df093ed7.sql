...
BEGIN
  ...
  -- NOTE: We do NOT delete from storage.objects here. Supabase blocks direct
  -- deletes on storage tables. The client removes the files via the Storage API
  -- using the returned deleted_paths.
