const translations = {
  ...
  sendFeedback: 'Fale Conosco',
  feedbackType: 'Assunto',
  selectFeedbackType: 'Selecione o assunto',
  feedbackMessage: 'Mensagem',
  feedbackMessagePlaceholder: 'Escreva sua mensagem detalhadamente...',
  ...
  feedbackSent: 'Mensagem enviada!',
  feedbackThankYou: 'Obrigado pela sua mensagem. Entraremos em contato em breve.',
  ...
  // Beta Notice
  betaNotice: '🚧 Esta ferramenta está em fase BETA e em DESENVOLVIMENTO. Para problemas ou sugestões, use o botão Fale Conosco.',
  ...
  rating: {
    question: 'Como foi essa conversão?',
    starLabel: '{{count}} estrela(s)',
    notNow: 'Agora não',
    improveQuestion: 'O que podemos melhorar?',
    commentPlaceholder: 'Conte o que deu errado (opcional)',
    skip: 'Pular',
    send: 'Enviar',
    thanksFeedback: 'Obrigado! Seu retorno nos ajuda a melhorar.',
    thanksHigh: 'Que bom que ajudou!',
    supportAsk: 'Se puder, apoie o projeto com qualquer valor via PIX.',
  },
