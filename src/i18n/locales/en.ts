const translations = {
  ...
  progressStepIndicator: 'Step {{current}} of {{total}}',
  ...
  rating: {
    question: 'How was this conversion?',
    starLabel: '{{count}} star(s)',
    notNow: 'Not now',
    improveQuestion: 'What can we improve?',
    commentPlaceholder: 'Tell us what went wrong (optional)',
    skip: 'Skip',
    send: 'Send',
    thanksFeedback: 'Thank you! Your feedback helps us improve.',
    thanksHigh: 'Glad it helped!',
    supportAsk: 'If you can, support the project with any amount via PIX.',
  },
