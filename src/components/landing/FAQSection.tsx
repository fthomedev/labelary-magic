...
const faqItems = [
  ...
  {
    id: 'item-2',
    questionPtBr: 'É seguro enviar meus arquivos ZPL',
    questionEn: 'Is it safe to upload my ZPL files',
    answerPtBr: 'Sim! Nossa plataforma utiliza protocolos de segurança avançados para proteger seus dados.',
    answerEn: 'Yes! Our platform uses advanced security protocols to protect your data.'
  },
  {
    id: 'item-3',
    questionPtBr: 'Posso converter vários arquivos ao mesmo tempo',
    questionEn: 'Can I convert multiple files at the same time',
    answerPtBr: 'Sim! Oferecemos suporte a conversões em lote dependendo do plano escolhido.',
    answerEn: 'Yes! We offer support for batch conversions depending on the chosen plan.'
  },
  {
    id: 'item-4',
    questionPtBr: 'Há limite de tamanho de arquivo',
    questionEn: 'Is there a file size limit',
    answerPtBr: 'Temos limites de acordo com cada plano. Consulte nossa documentação para mais detalhes.',
    answerEn: 'We have limits according to each plan. Check our documentation for more details.'
  },
  {
    id: 'item-5',
